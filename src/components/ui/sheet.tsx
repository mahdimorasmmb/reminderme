...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col items-start space-y-2 text-center sm:text-left",
      className
    )}
    {...props}
  />
